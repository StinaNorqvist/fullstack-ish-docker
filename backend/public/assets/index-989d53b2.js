 ...
 */ (function (e) {
  ...
  function E(x, P) {
    ...
    try {
      for (
        d(P), p = t(s);
        p !== null && (!(p.expirationTime > P) || (x && !Ne()));

      ) {
        var W = p.callback;
        if (typeof W == "function") {
          (p.callback = null), (m = p.priorityLevel);
          var G = W(p.expirationTime <= P);
          (P = e.unstable_now()),
            typeof G == "function" ? (p.callback = G) : p === t(s) && r(s),
            d(P);
        } else r(s);
        p = t(s);
      }
      ...
      return (
        ...
        z > W
          ? ((x.sortIndex = z),
            ...
            t(s) === null &&
              x === t(c) &&
              (w ? (f(N), (N = -1)) : (w = !0), yl(v, z - W)))
          : ((x.sortIndex = G), n(s, x), S || g || ((S = !0), vl(E))),
        x
      );
    }),
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = jt(a, f)), v != null && w.push(At(a, v, d)))),
            F)
          )
            break;
          a = a.return;
      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            n: {
              for (w = g, f = S, a = 0, d = w; d; d = jn(d)) a++;
...
function Qr(e, n, t, r) {
  ...
  if (o !== null) {
    ...
    (Ln |= i), (e.lanes = i), (e.memoizedState = p);
  }
}
function gu(e, n, t) {
...
function Lu(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    ...
    u !== p || m !== S || fe.current || Je
      ? (typeof g == "function" && (xo(n, t, g, r), (S = n.memoizedState)),
        (c = Je || wu(n, t, c, r, m, S, s) || !1)
          ? (h ||
                ...
                if (S !== null) {
                  var w = S.memoizedProps,
                    ...
                    a = f.getSnapshotBeforeUpdate(
                      n.elementType === n.type ? w : ze(n.type, w),
                      F
                    );
...
function jd() {
  return j.jsx("svg", {
    ...
    children: j.jsx("path", {
      ...
      strokeLinecap: "round",
      strokeLinejoin: "round",
      d: "M6.5 10.25h1m-7 3l3.5-2m-3.5-3l4 1m2.98-6.97L12.87.77a.46.46 0 0 1 .46.11a.49.49 0 0 1 .16.45l-1.1 5.61c-.06-.15-.12-.31-.17-.47A5.75 5.75 0 0 0 7 2.25a5.75 5.75 0 0 0-5.22 4.22c-.05.17-.11.32-.17.48L.51 1.33A.49.49 0 0 1 .67.88a.46.46 0 0 1 .46-.11l5.39 1.51m1.98 10.8a6.7 6.7 0 0 1-3 0m8 .17l-3.5-2m3.5-3l-4 1",
    }),
  });
}
function Md() {
  ...
  const s = () => {
    ...
    c = (p, m, g) => {
      fetch("/api", {
        ...
        body: JSON.stringify({ name: p, age: m, species: g }),
      })
        .then((w) => w.json())
        .then((w) => {
          n(w), s();
        ...
        .catch((w) => {
          console.log(w, "Failed posting a new pet");
        });
    },
    h = (p) => {
      fetch("/api", {
        ...
        .catch((m) => {
          console.log(m, `Failed to delete pet with id ${p}`);
        });
    };
  return j.jsxs(j.Fragment, {
    children: [
      ...
      j.jsx("h1", { className: "secondHeader", children: "Your pets" }),
      j.jsx("div", {
        ...
        children: e.map((p) =>
          j.jsxs(
            "div",
            {
              className: "petDiv",
              children: [
                j.jsx("p", { className: "petName", children: p.name }),
                j.jsx("p", { className: "petSpecies", children: p.species }),
                j.jsxs("p", {
                  className: "petAge",
                  children: [p.age, " years old"],
                }),
                j.jsx(
                  "button",
                  {
